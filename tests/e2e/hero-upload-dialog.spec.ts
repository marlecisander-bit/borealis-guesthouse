...
function controlBundle() {
  ...
  modules['next/image'] = `module.exports=({fill,sizes,...props})=>require('react').createElement('img',{...props,sizes,style:fill?{position:'absolute',inset:0,width:'100%',height:'100%'}:undefined});`;
