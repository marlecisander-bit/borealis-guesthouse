...
export default function AdminLayout({
  ...
  return (
    <div data-admin-shell className="flex min-h-screen"><SlugChangeGuard/><TranslationShortcut/><AdminFormValueGuard/>
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <div className="flex items-center gap-3 border-b border-[#c7dddb] bg-[#f8fbfa] px-4 py-3 lg:hidden"><AdminMobileNav/><span className="font-bold text-[#164b59]">Borealis CMS</span></div>
        <AdminHeader />
        <main id="admin-main" className="flex-1 overflow-x-hidden" tabIndex={-1}>
          <div className="mx-auto w-full max-w-[90rem] p-4 sm:p-6 lg:p-8">{children}</div>
        </main>
      </div>
    </div>
  );
