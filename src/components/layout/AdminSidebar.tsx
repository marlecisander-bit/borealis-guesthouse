...
export default function AdminSidebar({ onNavigate }: { onNavigate?: () => void }) {
  ...
  return <aside className="flex h-full w-64 max-w-full shrink-0 flex-col border-r border-[#c7dddb] bg-[#f8fbfa]">
    ...
    <div className="border-t border-[#d7e7e4] p-4"><Link href="/" target="_blank" className="flex min-h-11 items-center rounded-lg px-3 text-sm font-semibold text-[#527277] hover:bg-[#e5f2f1] hover:text-[#164b59]">View public website ↗</Link></div>
  </aside>;
}
